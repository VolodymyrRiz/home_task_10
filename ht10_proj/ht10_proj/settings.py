...
SECRET_KEY = 'django-insecure-ypw4!938u!h)hylakf@nfyui_=ack@w!v*y$^+$=1kg)t=o#aq'
...
WSGI_APPLICATION = 'ht10_proj.wsgi.application'
...
LOGIN_REDIRECT_URL = 'quotes:main'
